...
<ActivityFeed title="Recent Community Deposits" items={[]} loading />
<ActivityFeed title="Latest Disbursements" items={[]} loading />
</div>
) : activity.length === 0 ? (
<EmptyState
icon="📭"
title="No treasury activity yet"
description="No deposit or disbursement activity is available right now. Check back soon."
/>
) : (
<div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
<ActivityFeed
